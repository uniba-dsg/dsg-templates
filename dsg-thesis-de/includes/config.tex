...
\newcommand{\makedeclaration}[3]
{
	...
	%
			...
			Des Weiteren erkläre ich, dass die digitale Fassung der gedruckten Ausfertigung der #1 ausnahmslos in Inhalt und Wortlaut entspricht und zur Kenntnis genommen wurde, dass diese digitale Fassung einer durch Software unterstützten, anonymisierten Prüfung auf Plagiate unterzogen werden kann.
			\vspace*{1cm}
