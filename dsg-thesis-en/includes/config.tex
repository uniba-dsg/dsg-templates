...
\newcommand{\makedeclaration}[3]
{
	...
	%
			\vspace*{16cm}
			I hereby declare that, pursuant to § 9 paragraph 12 APO, I wrote the preceding #1 independently 
			and did not use any sources or means other than those indicated.
			Furthermore, I declare that the digital version of my #1 is identical with the contents and wording of the printed version without exception and acknowledge that this digital version may be subjected to a software supported and anonymised screening for plagiarism.
			\vspace*{1cm}
